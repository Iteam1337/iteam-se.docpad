...
if (!!turnoverNumbers) {
  data = {
    labels: ['1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013'],
    datasets: [
      {
        ...
        data: [0.12, 0.2, 0.53, 1.1, 2.7, 3.7, 3.7, 2.7, 3.2, 3.9, 4.2, 7, 7.5, 7.5, 8.5, 10, 9.3, 11.6, 13.3]
      }
    ]
  };
    ...
    datasets: [
      {
        ...
        pointStrokeColor: "#fff",
        data: [0, 0, 1, 2, 3, 4, 3, 4, 4, 4, 6, 7, 7, 8, 9, 10, 11, 12, 14]
      }
    ]
  };
